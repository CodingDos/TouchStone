    ...
    <div className="dircard">
      <div className="dircard-examples">
        <div className="dircard-example1">
          <h3 style={props.titleStyle}> {props.example1} </h3>
          <img
            style={props.imgStyle}
            className="dircard-braille-img"
            src={img1?.braille_img}
          />
        </div>
        <div className="dircard-example2">
          <h3 style={props.titleStyle}> {props.example2} </h3>
          <img
            style={props.imgStyle}
            className="dircard-braille-img"
            src={img2?.braille_img}
          />
        </div>
        <div className="dircard-example3">
          <h3 style={props.titleStyle}> {props.example3} </h3>
          <img
            style={props.imgStyle}
            className="dircard-braille-img"
            src={img3?.braille_img}
          />
        </div>
      </div>
      <h4 style={props.dirTitle}>{props.title}</h4>
    </div>
  );
}
