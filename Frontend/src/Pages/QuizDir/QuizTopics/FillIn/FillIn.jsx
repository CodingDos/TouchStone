...
function FillIn() {
  ...
  const onClickForward = () => {
	...
	const handleChange = (e) => {
		...
		testArray[parseInt(e.target.id)] = (testArray[parseInt(e.target.id)]+1)%2;
  ...
  return (
    <div className="fillin">
      ...
      <div className="fillin-carosel">
        <h1 className="directory-title">Fill In</h1>
	<h2 className="message">{message}</h2>
        <div className="carosel">
    		...
    		>
      			<h3 className='card-title'>{collection[tracker]?.english || collection[tracker]?.phrase}</h3>
      			<div className = "braille-fillin" >
	  			<div id="column1">
	  				<div className="check" id="c0">
	  					<input type = "checkbox" className="check3" id="0" name="0" onChange={handleChange}/>
	  				</div>
	  				<div className="check" id ="c1">
	  					<input type = "checkbox" className="check3" id="1" name="1" onChange={handleChange}/>
	  				</div>
	  				<div className="check" id="c2">
	  					<input type = "checkbox" className="check3" id="2" name="2" onChange={handleChange}/>
	  				</div>
	  			</div>
	  			<div id="column2">
	  				<div className="check" id="c3">
	  					<input type = "checkbox" className="check3" id="3" name="3" onChange={handleChange}/>
	  				</div>
	  				<div className="check" id="c4">
	  					<input type = "checkbox" className="check3" id="4" name="4" onChange={handleChange}/>
	  				</div>
	  				<div className="check" id="c5">
	  					<input type = "checkbox" className="check3" id="5" name="5" onChange={handleChange}/>
	  				</div>
	  			</div>
	  		</div>
